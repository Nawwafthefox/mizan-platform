...
public class BranchMaps {
    public static final Map<String,String> BRANCH_NAME = Map.ofEntries(
        ...
        Map.entry("3407","حفر الباطن 7"), Map.entry("3408","حفر الباطن 8"),
        Map.entry("4022","العلا"),
        Map.entry("4405","المدينة 5"),
    ...
    public static final Map<String,String> BRANCH_REGION = Map.ofEntries(
        ...
        Map.entry("3407","حفر الباطن"), Map.entry("3408","حفر الباطن"),
        Map.entry("4022","المدينة المنورة"),
